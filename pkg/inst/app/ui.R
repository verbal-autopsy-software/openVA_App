...
ui <- fluidPage(
  ...
  p("This work is supported by: National Institutes of Health,",
    ...
    #HTML("National Institutes of Health <br>"), 
    # HTML("WHO Reference Group for Verbal Autopsy <br>"), 
    # HTML("Data for Health and Vital Strategies <br>"),
    # img(src="d4h.jpg", style="width:100px"),
    # img(src="vital_strategies.png", style="width:10px")),
  hr(),
  shinyjs::useShinyjs(),
